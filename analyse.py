...
def SpectraSumROIs(Parent, Data, path, resultPath, detectors = [2], nestingType = "OtO", origin = "upper", aspect = "auto", roi = None, pos = None, calib = None, vmin = None, vmax = None, maspect = "equal", emin = 0.0, emax = None, saspect = "auto", cmap = "viridis", normtype = [], disp = None, csvs = False):
    ...
    if disp["Selected"] and (Parent.PointChanged or Parent.AreaChanged):
        Hist, Fig = PDA.Hist_plot(data, head, f"{dataName} (extracted)", numpy.sum, pos, calib, detectors, Emax = emax, ROI = roi, log = True, Aspect = saspect, Emin = emin, Disp = disp)
        plt.close('all')
    ...
    Hist, Fig = PDA.Hist_plot(data, head, f"{dataName}", numpy.sum, None, calib, detectors, Emax = emax, ROI = roi, log = True, Aspect = saspect, Emin = emin, Disp = disp)
    plt.close('all')
...
def SpectraMaxROIs(Parent, Data, path, resultPath, detectors = [2], nestingType = "OtO", origin = "upper", aspect = "auto", roi = None, pos = None, calib = None, vmin = None, vmax = None, maspect = "equal", emin = 0.0, emax = None, saspect = "auto", cmap = "viridis", normtype = [], disp = None, csvs = False):
    ...
    os.makedirs(outputPath, exist_ok = True)
    if disp["Selected"] and (Parent.PointChanged or Parent.AreaChanged):
        Hist, Fig = PDA.Hist_plot(data, head, f"{dataName} (extracted)", numpy.max, pos, calib, detectors, Emax = emax, ROI = roi, log = False, Aspect = saspect, Emin = emin, Disp = disp)
        plt.close('all')
    ...
    Hist, Fig = PDA.Hist_plot(data, head, f"{dataName}", numpy.max, None, calib, detectors, Emax = emax, ROI = roi, log = False, Aspect = saspect, Emin = emin, Disp = disp)
    plt.close('all')
...
def SpectraSum(Parent, Data, path, resultPath, detectors = [2], nestingType = "OtO", origin = "upper", aspect = "auto", roi = None, pos = None, calib = None, vmin = None, vmax = None, maspect = "equal", emin = 0.0, emax = None, saspect = "auto", cmap = "viridis", normtype = [], disp = None, csvs = False):
    ...
    os.makedirs(outputPath, exist_ok = True)
    if disp["Selected"] and (Parent.PointChanged or Parent.AreaChanged):
        Hist, Fig = PDA.Hist_plot(data, head, f"{dataName} (extracted)", numpy.sum, pos, calib, detectors, Emax = emax, ROI = None, log = True, Aspect = saspect, Emin = emin, Disp = disp)
        plt.close('all')
    ...
    Hist, Fig = PDA.Hist_plot(data, head, f"{dataName}", numpy.sum, None, calib, detectors, Emax = emax, ROI = None, log = True, Aspect = saspect, Emin = emin, Disp = disp)
    plt.close('all')
...
def SpectraMax(Parent, Data, path, resultPath, detectors = [2], nestingType = "OtO", origin = "upper", aspect = "auto", roi = None, pos = None, calib = None, vmin = None, vmax = None, maspect = "equal", emin = 0.0, emax = None, saspect = "auto", cmap = "viridis", normtype = [], disp = None, csvs = False):
    ...
    os.makedirs(outputPath, exist_ok = True)
    if disp["Selected"] and (Parent.PointChanged or Parent.AreaChanged):
        Hist, Fig = PDA.Hist_plot(data, head, f"{dataName} (extracted)", numpy.max, pos, calib, detectors, Emax = emax, ROI = None, log = False, Aspect = saspect, Emin = emin, Disp = disp)
        plt.close('all')
    ...
    Hist, Fig = PDA.Hist_plot(data, head, f"{dataName}", numpy.max, None, calib, detectors, Emax = emax, ROI = None, log = False, Aspect = saspect, Emin = emin, Disp = disp)
    plt.close('all')
