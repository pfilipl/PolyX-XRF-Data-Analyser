...
class SingleWindow(QtWidgets.QWidget):
    ...
    def LoadData(self, startLoad = True, importLoad = False):
        ...
        try:
            ...
            self.LoadMapData(importLoad = importLoad)
    ...
    def LoadMapData(self, roiStart = 0, roiStop = 4096, pos = [[0, 0], [1000, 1000]], importLoad = False):
        ...
        if (self.AreaChanged or self.PointChanged) and not importLoad:
    ...
    def LoadSpectrum(self, pos = [[0, 0], [1000, 1000]], Emin = 0.0, Emax = None, roi = None, peaks = True, startLoad = True, importLoad = False):
        ...
        if (self.AreaChanged or self.PointChanged) and not (startLoad or importLoad):
